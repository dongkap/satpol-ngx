...
export const apiPath: APIModel = {
    ...
    security: {
        ...
        'get-profile-other': {
            server: environment.host.security,
            method: HttpMethod.POST,
            path: '/api/security/vw/auth/profile-other/v.1',
        },
        'get-profile-system-other': {
            server: environment.host.security,
            method: HttpMethod.POST,
            path: '/api/security/vw/auth/profile-system-other/v.1',
        },
    },
    profile: {
        'change-profile': {
        ...
        'change-profile-system': {
            server: environment.host.profile,
            method: HttpMethod.POST,
            path: '/api/profile/trx/auth/profile-system/v.1',
        },
        'get-profile-system': {
            server: environment.host.profile,
            method: HttpMethod.GET,
            path: '/api/profile/vw/auth/profile-system/v.1',
        },
    },
    master: {
        'select-country': {
    ...
    notification: {
        ...
        'push-subscribe': {
            server: environment.host.notification,
            method: HttpMethod.POST,
            path: '/api/notification/push/subscribe/v.1',
        },
    },
};
