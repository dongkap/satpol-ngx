(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    ImageUploadComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.16", type: ImageUploadComponent, selector: "do-image-upload", inputs: { image: "image", height: "height", width: "width", radius: "radius", buttonUpload: "buttonUpload", skeleton: "skeleton", uploadFn: "uploadFn" }, outputs: { onPreview: "onPreview" }, usesInheritance: true, ngImport: i0__namespace, template: "<div class=\"body-upload\">\n  <div *ngIf=\"!skeleton; else contentskeleton\"\n    class=\"upload-container\"\n    (click)=\"img.click()\"\n    doDragDrop\n    (onFileDropped)=\"upload($event)\"\n    [ngClass]=\"{\n      'full-file': image,\n      'empty-file': !image\n    }\"\n    [ngStyle]=\"{ \n      'background-image': 'url(' + (image) + ')',\n      'height':  height ? height+'rem' : 'calc(80vw/5)',\n      'width':  width ? width+'rem' : 'calc(80vw/5)',\n      'border-radius':  radius + '%'\n    }\">\n    <label *ngIf=\"!image\"\n      class=\"label label-upload\"\n      [ngStyle]=\"{\n        'line-height':  height ? height+'rem' : 'calc(80vw/5)'\n      }\">\n      {{ 'placeholder.image-upload' | translate }}\n    </label>\n    <input\n      hidden\n      type=\"file\"\n      accept=\"image/png, image/jpeg, image/jpg\"\n      (change)=\"upload($event.target.files)\"\n      #img>\n  </div>\n  <ng-template #contentskeleton>\n    <div\n      [ngClass]=\"{\n        'skeleton': skeleton\n      }\"\n      [ngStyle]=\"{ \n        'height':  height ? height+'rem' : 'calc(80vw/5)',\n        'width':  width ? width+'rem' : 'calc(80vw/5)',\n        'border-radius':  radius + '%',\n        'margin': '0.5rem auto'\n      }\">\n    </div>\n  </ng-template>\n</div>", styles: [".nb-theme-default .upload-container{background-repeat:no-repeat;background-size:cover;margin:.5rem auto}.nb-theme-default .empty-file{background-color:#edf1f7!important;outline:.125rem dashed #8f9bb3;outline-offset:-.4rem}.nb-theme-default .full-file{background-color:#fff!important;outline:.1rem solid #8f9bb3}.nb-theme-default .label-upload{display:flex;align-items:center;justify-content:center}.nb-theme-default .upload-container:hover{cursor:pointer}.nb-theme-default .body-upload{margin:.5rem;display:flex;justify-content:center;align-items:center}@media (max-width: 399.98px){.nb-theme-default .upload-container{height:10rem!important;width:10rem!important;border-radius:50%!important}.nb-theme-default .label-upload{line-height:10rem!important}.nb-theme-default .body-upload .skeleton{height:10rem!important;width:10rem!important}}.nb-theme-dark .upload-container{background-repeat:no-repeat;background-size:cover;margin:.5rem auto}.nb-theme-dark .empty-file{background-color:#151a30!important;outline:.125rem dashed #8f9bb3;outline-offset:-.4rem}.nb-theme-dark .full-file{background-color:#222b45!important;outline:.1rem solid #8f9bb3}.nb-theme-dark .label-upload{display:flex;align-items:center;justify-content:center}.nb-theme-dark .upload-container:hover{cursor:pointer}.nb-theme-dark .body-upload{margin:.5rem;display:flex;justify-content:center;align-items:center}@media (max-width: 399.98px){.nb-theme-dark .upload-container{height:10rem!important;width:10rem!important;border-radius:50%!important}.nb-theme-dark .label-upload{line-height:10rem!important}.nb-theme-dark .body-upload .skeleton{height:10rem!important;width:10rem!important}}.nb-theme-cosmic .upload-container{background-repeat:no-repeat;background-size:cover;margin:.5rem auto}.nb-theme-cosmic .empty-file{background-color:#1b1b38!important;outline:.125rem dashed #8f9bb3;outline-offset:-.4rem}.nb-theme-cosmic .full-file{background-color:#323259!important;outline:.1rem solid #8f9bb3}.nb-theme-cosmic .label-upload{display:flex;align-items:center;justify-content:center}.nb-theme-cosmic .upload-container:hover{cursor:pointer}.nb-theme-cosmic .body-upload{margin:.5rem;display:flex;justify-content:center;align-items:center}@media (max-width: 399.98px){.nb-theme-cosmic .upload-container{height:10rem!important;width:10rem!important;border-radius:50%!important}.nb-theme-cosmic .label-upload{line-height:10rem!important}.nb-theme-cosmic .body-upload .skeleton{height:10rem!important;width:10rem!important}}.nb-theme-corporate .upload-container{background-repeat:no-repeat;background-size:cover;margin:.5rem auto}.nb-theme-corporate .empty-file{background-color:#edf1f7!important;outline:.125rem dashed #8f9bb3;outline-offset:-.4rem}.nb-theme-corporate .full-file{background-color:#fff!important;outline:.1rem solid #8f9bb3}.nb-theme-corporate .label-upload{display:flex;align-items:center;justify-content:center}.nb-theme-corporate .upload-container:hover{cursor:pointer}.nb-theme-corporate .body-upload{margin:.5rem;display:flex;justify-content:center;align-items:center}@media (max-width: 399.98px){.nb-theme-corporate .upload-container{height:10rem!important;width:10rem!important;border-radius:50%!important}.nb-theme-corporate .label-upload{line-height:10rem!important}.nb-theme-corporate .body-upload .skeleton{height:10rem!important;width:10rem!important}}\n"], directives: [{ type: i4__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: DragDropDirective, selector: "[doDragDrop]", inputs: ["opacity"], outputs: ["onFileDropped"] }, { type: i4__namespace.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { type: i4__namespace.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }], pipes: { "translate": i5__namespace.TranslatePipe }, encapsulation: i0__namespace.ViewEncapsulation.None });
