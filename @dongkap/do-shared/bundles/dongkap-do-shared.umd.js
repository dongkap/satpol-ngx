    ...
    ***************************************************************************** */
    ...
    var DoInputTextComponent = /** @class */ (function (_super) {
        ...
        function DoInputTextComponent(ngControl, locale) {
            ...
            _this.type = 'text';
            _this.togglePassword = false;
            _this.showPassword = false;
            _this.icon = 'eye-outline';
            return _this;
        }
        DoInputTextComponent.prototype.onInit = function () {
            if (this.type === 'password') {
                this.togglePassword = true;
            }
        };
        DoInputTextComponent.prototype.onShowPassword = function () {
