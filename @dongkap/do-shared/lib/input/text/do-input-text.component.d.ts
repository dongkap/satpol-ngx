...
export declare class DoInputTextComponent extends ValueAccessorDirective<string> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DoInputTextComponent, "do-input-text", never, { "placeholder": "placeholder"; "colLabel": "colLabel"; "colInput": "colInput"; "minLength": "minLength"; "maxLength": "maxLength"; "min": "min"; "max": "max"; "step": "step"; "capslock": "capslock"; "type": "type"; }, {}, never, never>;
}
